...
function PopularProducts() {
  return (
    ...
    <div className='bg-white px-4 pt-3 pb-4 rounded-sm border border-gray-200 w-[20rem] overflow-auto'>
        <strong className='text-gray-700 font-medium'> Popular products</strong>
        <div className='mt-4 flex flex-col gap-3'>
          {popularProducts.map( product => (
            <Link key={product.id} to={'/products/${product.id}'} className='flex hover:no-underline'>
